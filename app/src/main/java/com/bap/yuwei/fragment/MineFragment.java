...
public class MineFragment extends BaseFragment implements View.OnClickListener{
    ...
    public void refreshUI() {
        if(null != mUser){
            ...
            ImageLoader.getInstance().displayImage("drawable://"+R.drawable.iconfont_touxiang,imgHead, DisplayImageOptionsUtil.getOptionsRounded(180,R.drawable.iconfont_touxiang));
